    ...
    <Container maxW="5xl" p={{ base: 5, md: 10 }}>
      ...
      >
        ...
        <Stack pos="relative" zIndex={1} direction="column" spacing={5} textAlign="left">
          <chakra.h1 color="white" fontSize="4xl" lineHeight={1.2} fontWeight="bold" textAlign={'center'}>
            Contáctenos
          </chakra.h1>
          ...
          <Stack justifyContent={'center'} direction={{ base: 'column', md: 'row' }} spacing={3}>
            <Button
              leftIcon={<FaFacebook />}
              as={Link}
              href="https://www.facebook.com/wsdservice"
              rounded="md"
              color="gray.800"
              bg="white"
              _hover={{ bg: 'gray.200' }}
            ...
            <Button
              leftIcon={<BsWhatsapp />}
              as={Link}
              href="https://api.whatsapp.com/send?phone=50672030437&text=Bienvenid@%20a%20WSD%20Servicios!"
              rounded="md"
              color="white"
              bg="green.00"
              _hover={{ bg: 'green.700' }}
